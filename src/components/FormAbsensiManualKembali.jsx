...
const mapStateToProps = (state) => {
   ...
   let initNama = state.Opt.getAfterFinger ?
      state.Opt.getAfterFinger.status == 1 ?
         {
            KeluarID: state.Opt.getAfterFinger.KeluarID,
   ...
   return {
      getOptUserManualKembali: state.Opt.getOptUserManualKembali,
      initialValues: {
         Nama: initNama
      }
   };
...
class FormAbsensiManualKembali extends Component {
   render() {
      return (
                        ...
                        <Col md={12}>
                           <FormGroup>
                              <Field
                                 ...
                                 options={this.props.getOptUserManualKembali}
                                 label="Nama:"
...
FormAbsensiManualKembali = reduxForm({
   form: "FormAbsensiManualKembali",
   validate: AbsensiManualValidation,
   enableReinitialize: true,
})(FormAbsensiManualKembali);
export default connect(mapStateToProps, null)(FormAbsensiManualKembali);
