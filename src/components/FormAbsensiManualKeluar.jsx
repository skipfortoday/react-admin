...
import { faFingerprint, faSave, faUndo, faUndoAlt } from "@fortawesome/free-solid-svg-icons";
...
const mapStateToProps = (state) => {
   ...
   return {
      getOptUserManualKeluar: state.Opt.getOptUserManualKeluar,
      initialValues: {
         Nama: initNama
      }
   };
...
class FormAbsensiManualKeluar extends Component {
   render() {
                        ...
                        <Col md={12}>
                           <FormGroup>
                              <Field
                                 ...
                                 options={this.props.getOptUserManualKeluar}
                                 label="Nama:"
...
FormAbsensiManualKeluar = reduxForm({
   form: "FormAbsensiManualKeluar",
   validate: AbsensiManualValidation,
   enableReinitialize: true,
})(FormAbsensiManualKeluar);
export default connect(mapStateToProps, null)(FormAbsensiManualKeluar);
