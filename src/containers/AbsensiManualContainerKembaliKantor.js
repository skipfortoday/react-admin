...
import { cekUserAfterFinger, getOptUserManualKembali, takeScreenShoot } from "../actions/optAction";
...
class AbsensiManualContainerKembaliKantor extends Component {
      ...
      client.onmessage = (message) => {
         ...
         if(result.Key == this.state.key){
            ...
            if(result.Status == "done"){
               ...
               this.props.dispatch(cekUserAfterFinger(this.state.UserID, "kembali"))
               takeScreenShoot(this.state.UserID+"_KEMBALI")
            }
         }
   ...
   componentDidUpdate() {
      if(this.props.getAfterFinger){
         ...
         setTimeout(() => {
            takeScreenShoot(this.state.UserID+"_KEMBALI_OK")
         }, 300);
      }

      if(this.props.errorgetAfterFinger){
         takeScreenShoot(this.state.UserID+"_KEMBALI_ERR")
                  ...
                  <Col md={7} style={{ paddingLeft: "5px", paddingRight: "5px" }}>
                     <div style={{ backgroundColor: "#f9a826" }} class="p-2 mb-2">
                        <Container>
                           <Row>
                              <Col md={6}>
                                 <h3 class="text-left mt-2 mb-2">Kembali Kantor</h3>
                              </Col>
                              <Col md={6}>
