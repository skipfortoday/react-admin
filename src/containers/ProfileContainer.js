...
import BackProfileComponent from "../components/BackProfileComponent";
  ...
  render() {
    ...
    return (
      <div>
        ...
        <div className="mt-4" >
          <Container>
            <BackProfileComponent title="Profile Admin" />
            <FormAdminComponent disabled={true} onSubmit={(data) => this.handleSubmit(data)} editing={true} />
          </Container>
        </div>
      </div>
    );
