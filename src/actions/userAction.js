...
export const getUsersList = () => {
  return (dispatch) => {
    axios
      .get("http://192.168.1.30:3001/api/user")
...
export const getUserV = () => {
  return (dispatch) => {
    axios
      .get("http://192.168.1.30:3001/api/vuser")
      .then(function (response) {
        dispatch({
          type: GET_USER_V,
          payload: {
...
export const postUserCreate = (data) => {
  return (dispatch) => {
    axios
      .post(
         "http://192.168.1.30:3001/api/user/",
        data
      )
      .then(function (response) {
...
export const resetUser = (UserID) => {
  return (dispatch) => {
    axios
      .put(
         "http://192.168.1.30:3001/api/resetdevice/"+UserID
      )
      .then(function (response) {
        console.log(response);
...
export const getCabangList = () => {
  return (dispatch) => {
    axios
      .get("http://192.168.1.30:3001/api/cabang")
      .then(function (response) {
        dispatch({
...
export const getCabangDetail = (KodeCabang) => {
  return (dispatch) => {
    axios
      .get(
        "http://192.168.1.30:3001/api/cabang/"+KodeCabang
      )
      .then(function (response) {
        dispatch({
...
export const postCabangCreate = (data) => {
  return (dispatch) => {
    axios
      .post(
         "http://192.168.1.30:3001/api/cabang/",
        data
      )
      .then(function (response) {
        console.log(response);
